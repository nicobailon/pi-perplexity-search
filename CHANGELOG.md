...
### Changed
- Refresh built-in curator summary defaults from Haiku + Codex Spark to Haiku, GPT-5.6 Luna, GPT-5.6 Terra (for ChatGPT Free/Go Codex users, who do not get Luna in Codex), Gemini 3.6 Flash, GPT-5 mini, and DeepSeek V4 Flash, and point query rewrite at GPT-5 mini instead of GPT-4.1 mini.
