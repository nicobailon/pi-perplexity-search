...
function runChild(script, env) {
	...
	for (const key of [
		...
		"PARALLEL_API_KEY", "TINYFISH_API_KEY", "TAVILY_API_KEY", "SERPDIVE_API_KEY", "KAGI_API_KEY", "OLLAMA_API_KEY", "SERPBASE_API_KEY", "BRIGHTDATA_API_KEY", "BRIGHTDATA_SERP_ZONE", "SEARXNG_BASE_URL", "EXA_API_KEY",
